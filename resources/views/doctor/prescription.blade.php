                    ...
                    <div class="card">
                        <div class="body">
                            <form method="POST" action="{{route('postPrescription')}}">
                                ...
                                <h3>Prescribe</h3>
                                <div class="strtPrep">
                                <button class="btn btn-success" id="add-more" type="button"><i class="glyphicon glyphicon-plus"></i> Add Medication</button>
                                <div id="medications">
                                <p>
<div class="row control-group">
    <div class="col-md-6">
        <div class="input-group">
        <div class="form-line">
            <input type="text" name="name[]" class="form-control searchname"  placeholder="Search..." id="searchname">
        </div>
        </div>
    </div>
    <div class="col-md-4">
    ...
    <input type="number" name="id[]" id="id" hidden>
                                ...
                                <div class="row">
                                    <div class="col-xs-4">
                                        <button class="btn btn-block bg-green waves-effect" type="submit">Prescribe</button>
                                    </div>
                                </div>
                            </form>
                        </div>
...
<script type="text/javascript">
    ...
    $('#add-more').on('click', function (e) {
        ...
        $('#searchname_' + i).autocomplete({
            source: "/doctor/find-medicine",
            minLength: 1,
            autoFocus:true,
            select: function(e,ui){
                var j = i-1;
                $('#id_' + j).val(ui.item.id);
            }
        });
        i++;
        return false;
