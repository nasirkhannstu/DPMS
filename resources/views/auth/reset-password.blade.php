...
<body class="fp-page">
    <div class="fp-box">
        <div class="logo">
            <a href="javascript:void(0);"><b style="color:wheat">DIGIBAN</b>GROUP</a>
            <small>Doctor Patient Management System</small>
        </div>
        <div class="card">
            <div class="body">
                <form action="" method="POST">
                    ...
                    <button class="btn btn-block btn-lg bg-red waves-effect" type="submit">Set Password</button>
