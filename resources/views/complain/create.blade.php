        ...
        <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
            <div class="row">
                ...
                <div class="card">
                    ...
                    <div class="header">
                        <h3>Doctor Name ({{$doctor->user->first_name}} {{$doctor->user->last_name}})</h3>
                    </div>
                    <hr>
                    <div class="body">
                        <br>
                        <h4>Is anything wrong with this doctor? Complain!!</h4>
                        <br>
                        <div class="search" style="margin-top:10px">
                            <form action="{{route('patient.post.complain', $doctor->user_id)}}" method="POST">
                                {{ csrf_field() }}
                            <div class="row control-group">
                                <div class="col-md-6 col-md-offset-2">
                                    <div class="input-group">
                                        <textarea class="form-control" name="complain" placeholder="Write Message" style="width:400px;height:150px" required></textarea>
                                    </div>
                                    <br>
